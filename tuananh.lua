...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u25.Name ~= 'Sea' then
                    if u25:FindFirstChild('NameEsp') then
                        u25.NameEsp.TextLabel.Text = u25.Name .. '   \n' .. round((game:GetService('Players').LocalPlayer.Character.Head.Position - u25.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui = Instance.new('BillboardGui', u25)

                        _BillboardGui.Name = 'NameEsp'
                        _BillboardGui.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui.Adornee = u25
            ...
            elseif u25:FindFirstChild('NameEsp') then
                u25:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u34.Character) then
                if ESPPlayer then
                    if isnil(u34.Character.Head) or u34.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u34.Character.Head['NameEsp' .. Number].TextLabel.Text = u34.Name .. ' | ' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u34.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u30(u34.Character.Humanoid.Health * 100 / u34.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui2 = Instance.new('BillboardGui', u34.Character.Head)

                        _BillboardGui2.Name = 'NameEsp' .. Number
                        _BillboardGui2.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui2.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui2.Adornee = u34.Character.Head
                        ...
                        _TextLabel2.Text = u34.Name .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u34.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u34.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel2.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel2.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u34.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u34.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u40:GetAttribute('IsDisabled') then
                    if u40:FindFirstChild('ChestEsp') then
                        local v41 = u40
                        local v42 = u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v41:GetPivot().Position).Magnitude / 3)

                        u40.ChestEsp.TextLabel.Text = 'Chest\n' .. v42 .. ' M'
                    else
                        local _BillboardGui3 = Instance.new('BillboardGui', u40)

                        _BillboardGui3.Name = 'ChestEsp'
                        _BillboardGui3.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui3.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui3.Adornee = u40
            ...
            elseif u40:FindFirstChild('ChestEsp') then
                u40:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u49.Name, 'Fruit') then
                    if u49.Handle:FindFirstChild('NameEsp' .. Number) then
                        u49.Handle['NameEsp' .. Number].TextLabel.Text = u49.Name .. '   \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u49.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui4 = Instance.new('BillboardGui', u49.Handle)

                        _BillboardGui4.Name = 'NameEsp' .. Number
                        _BillboardGui4.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui4.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui4.Adornee = u49.Handle
                        ...
                        _TextLabel4.Text = u49.Name .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u49.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u49.Handle:FindFirstChild('NameEsp' .. Number) then
                u49.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u55.Name == 'Flower2' or u55.Name == 'Flower1' then
                if FlowerESP then
                    if u55:FindFirstChild('NameEsp' .. Number) then
                        u55['NameEsp' .. Number].TextLabel.Text = u55.Name .. '   \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u55.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui5 = Instance.new('BillboardGui', u55)

                        _BillboardGui5.Name = 'NameEsp' .. Number
                        _BillboardGui5.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui5.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui5.Adornee = u55
                        ...
                        if u55.Name == 'Flower1' then
                            _TextLabel5.Text = 'Blue Flower' .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u55.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel5.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u55.Name == 'Flower2' then
                            _TextLabel5.Text = 'Red Flower' .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u55.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel5.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u55:FindFirstChild('NameEsp' .. Number) then
                    u55:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v61:IsA('Tool') then
            if RealFruitESP then
                if v61.Handle:FindFirstChild('NameEsp' .. Number) then
                    v61.Handle['NameEsp' .. Number].TextLabel.Text = v61.Name .. ' ' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v61.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui6 = Instance.new('BillboardGui', v61.Handle)

                    _BillboardGui6.Name = 'NameEsp' .. Number
                    _BillboardGui6.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui6.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui6.Adornee = v61.Handle
                    ...
                    _TextLabel6.Text = v61.Name .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v61.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v67:IsA('Tool') then
            if RealFruitESP then
                if v67.Handle:FindFirstChild('NameEsp' .. Number) then
                    v67.Handle['NameEsp' .. Number].TextLabel.Text = v67.Name .. ' ' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v67.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui7 = Instance.new('BillboardGui', v67.Handle)

                    _BillboardGui7.Name = 'NameEsp' .. Number
                    _BillboardGui7.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui7.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui7.Adornee = v67.Handle
                    ...
                    _TextLabel7.Text = v67.Name .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v67.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v73:IsA('Tool') then
            if RealFruitESP then
                if v73.Handle:FindFirstChild('NameEsp' .. Number) then
                    v73.Handle['NameEsp' .. Number].TextLabel.Text = v73.Name .. ' ' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v73.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui8 = Instance.new('BillboardGui', v73.Handle)

                    _BillboardGui8.Name = 'NameEsp' .. Number
                    _BillboardGui8.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui8.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui8.Adornee = v73.Handle
                    ...
                    _TextLabel8.Text = v73.Name .. ' \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - v73.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u79.Name ~= 'Sea' then
                    if u79:FindFirstChild('NameEsp') then
                        u79.NameEsp.TextLabel.Text = u79.Name .. '   \n' .. u30((game:GetService('Players').LocalPlayer.Character.Head.Position - u79.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui9 = Instance.new('BillboardGui', u79)

                        _BillboardGui9.Name = 'NameEsp'
                        _BillboardGui9.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui9.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui9.Adornee = u79
            ...
            elseif u79:FindFirstChild('NameEsp') then
                u79:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u88.Character) then
                if ESPPlayer then
                    if isnil(u88.Character.Head) or u88.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u88.Character.Head['NameEsp' .. Number].TextLabel.Text = u88.Name .. ' | ' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u88.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u84(u88.Character.Humanoid.Health * 100 / u88.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui10 = Instance.new('BillboardGui', u88.Character.Head)
                        ...
                        _BillboardGui10.Adornee = u88.Character.Head
                        ...
                        _TextLabel10.Text = u88.Name .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u88.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u88.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel10.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel10.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u88.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u88.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u94:GetAttribute('IsDisabled') then
                    if u94:FindFirstChild('ChestEsp') then
                        local v95 = u94
                        local v96 = u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v95:GetPivot().Position).Magnitude / 3)

                        u94.ChestEsp.TextLabel.Text = 'Chest\n' .. v96 .. ' M'
                    else
                        local _BillboardGui11 = Instance.new('BillboardGui', u94)

                        _BillboardGui11.Name = 'ChestEsp'
                        _BillboardGui11.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui11.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui11.Adornee = u94
            ...
            elseif u94:FindFirstChild('ChestEsp') then
                u94:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u103.Name, 'Fruit') then
                    if u103.Handle:FindFirstChild('NameEsp' .. Number) then
                        u103.Handle['NameEsp' .. Number].TextLabel.Text = u103.Name .. '   \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u103.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui12 = Instance.new('BillboardGui', u103.Handle)
                        ...
                        _BillboardGui12.Adornee = u103.Handle
                        ...
                        _TextLabel12.Text = u103.Name .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u103.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u103.Handle:FindFirstChild('NameEsp' .. Number) then
                u103.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u109.Name == 'Flower2' or u109.Name == 'Flower1' then
                if FlowerESP then
                    if u109:FindFirstChild('NameEsp' .. Number) then
                        u109['NameEsp' .. Number].TextLabel.Text = u109.Name .. '   \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u109.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui13 = Instance.new('BillboardGui', u109)
                        ...
                        if u109.Name == 'Flower1' then
                            _TextLabel13.Text = 'Blue Flower' .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u109.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel13.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u109.Name == 'Flower2' then
                            _TextLabel13.Text = 'Red Flower' .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u109.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel13.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u109:FindFirstChild('NameEsp' .. Number) then
                    u109:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v115:IsA('Tool') then
            if RealFruitESP then
                if v115.Handle:FindFirstChild('NameEsp' .. Number) then
                    v115.Handle['NameEsp' .. Number].TextLabel.Text = v115.Name .. ' ' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v115.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui14 = Instance.new('BillboardGui', v115.Handle)
                    ...
                    _BillboardGui14.Adornee = v115.Handle
                    ...
                    _TextLabel14.Text = v115.Name .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v115.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v121:IsA('Tool') then
            if RealFruitESP then
                if v121.Handle:FindFirstChild('NameEsp' .. Number) then
                    v121.Handle['NameEsp' .. Number].TextLabel.Text = v121.Name .. ' ' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v121.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui15 = Instance.new('BillboardGui', v121.Handle)
                    ...
                    _BillboardGui15.Adornee = v121.Handle
                    ...
                    _TextLabel15.Text = v121.Name .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v121.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v127:IsA('Tool') then
            if RealFruitESP then
                if v127.Handle:FindFirstChild('NameEsp' .. Number) then
                    v127.Handle['NameEsp' .. Number].TextLabel.Text = v127.Name .. ' ' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v127.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui16 = Instance.new('BillboardGui', v127.Handle)
                    ...
                    _BillboardGui16.Adornee = v127.Handle
                    ...
                    _TextLabel16.Text = v127.Name .. ' \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - v127.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u133.Name ~= 'Sea' then
                    if u133:FindFirstChild('NameEsp') then
                        u133.NameEsp.TextLabel.Text = u133.Name .. '   \n' .. u84((game:GetService('Players').LocalPlayer.Character.Head.Position - u133.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui17 = Instance.new('BillboardGui', u133)

                        _BillboardGui17.Name = 'NameEsp'
                        _BillboardGui17.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui17.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui17.Adornee = u133
            ...
            elseif u133:FindFirstChild('NameEsp') then
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u142.Character) then
                if ESPPlayer then
                    if isnil(u142.Character.Head) or u142.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u142.Character.Head['NameEsp' .. Number].TextLabel.Text = u142.Name .. ' | ' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u142.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u138(u142.Character.Humanoid.Health * 100 / u142.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui18 = Instance.new('BillboardGui', u142.Character.Head)
                        ...
                        _BillboardGui18.Adornee = u142.Character.Head
                        ...
                        _TextLabel18.Text = u142.Name .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u142.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u142.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel18.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel18.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u142.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u142.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u148:GetAttribute('IsDisabled') then
                    if u148:FindFirstChild('ChestEsp') then
                        local v149 = u148
                        local v150 = u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v149:GetPivot().Position).Magnitude / 3)

                        u148.ChestEsp.TextLabel.Text = 'Chest\n' .. v150 .. ' M'
                    else
                        local _BillboardGui19 = Instance.new('BillboardGui', u148)

                        _BillboardGui19.Name = 'ChestEsp'
                        _BillboardGui19.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui19.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui19.Adornee = u148
            ...
            elseif u148:FindFirstChild('ChestEsp') then
                u148:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u157.Name, 'Fruit') then
                    if u157.Handle:FindFirstChild('NameEsp' .. Number) then
                        u157.Handle['NameEsp' .. Number].TextLabel.Text = u157.Name .. '   \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u157.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui20 = Instance.new('BillboardGui', u157.Handle)
                        ...
                        _BillboardGui20.Adornee = u157.Handle
                        ...
                        _TextLabel20.Text = u157.Name .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u157.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u157.Handle:FindFirstChild('NameEsp' .. Number) then
                u157.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u163.Name == 'Flower2' or u163.Name == 'Flower1' then
                if FlowerESP then
                    if u163:FindFirstChild('NameEsp' .. Number) then
                        u163['NameEsp' .. Number].TextLabel.Text = u163.Name .. '   \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u163.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui21 = Instance.new('BillboardGui', u163)
                        ...
                        if u163.Name == 'Flower1' then
                            _TextLabel21.Text = 'Blue Flower' .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u163.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel21.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u163.Name == 'Flower2' then
                            _TextLabel21.Text = 'Red Flower' .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u163.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel21.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u163:FindFirstChild('NameEsp' .. Number) then
                    u163:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v169:IsA('Tool') then
            if RealFruitESP then
                if v169.Handle:FindFirstChild('NameEsp' .. Number) then
                    v169.Handle['NameEsp' .. Number].TextLabel.Text = v169.Name .. ' ' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v169.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui22 = Instance.new('BillboardGui', v169.Handle)
                    ...
                    _BillboardGui22.Adornee = v169.Handle
                    ...
                    _TextLabel22.Text = v169.Name .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v169.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v175:IsA('Tool') then
            if RealFruitESP then
                if v175.Handle:FindFirstChild('NameEsp' .. Number) then
                    v175.Handle['NameEsp' .. Number].TextLabel.Text = v175.Name .. ' ' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v175.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui23 = Instance.new('BillboardGui', v175.Handle)
                    ...
                    _BillboardGui23.Adornee = v175.Handle
                    ...
                    _TextLabel23.Text = v175.Name .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v175.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v181:IsA('Tool') then
            if RealFruitESP then
                if v181.Handle:FindFirstChild('NameEsp' .. Number) then
                    v181.Handle['NameEsp' .. Number].TextLabel.Text = v181.Name .. ' ' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v181.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui24 = Instance.new('BillboardGui', v181.Handle)
                    ...
                    _BillboardGui24.Adornee = v181.Handle
                    ...
                    _TextLabel24.Text = v181.Name .. ' \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - v181.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u187.Name ~= 'Sea' then
                    if u187:FindFirstChild('NameEsp') then
                        u187.NameEsp.TextLabel.Text = u187.Name .. '   \n' .. u138((game:GetService('Players').LocalPlayer.Character.Head.Position - u187.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui25 = Instance.new('BillboardGui', u187)

                        _BillboardGui25.Name = 'NameEsp'
                        _BillboardGui25.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui25.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui25.Adornee = u187
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u196.Character) then
                if ESPPlayer then
                    if isnil(u196.Character.Head) or u196.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u196.Character.Head['NameEsp' .. Number].TextLabel.Text = u196.Name .. ' | ' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u196.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u192(u196.Character.Humanoid.Health * 100 / u196.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui26 = Instance.new('BillboardGui', u196.Character.Head)
                        ...
                        _BillboardGui26.Adornee = u196.Character.Head
                        ...
                        _TextLabel26.Text = u196.Name .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u196.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u196.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel26.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel26.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u196.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u196.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u202:GetAttribute('IsDisabled') then
                    if u202:FindFirstChild('ChestEsp') then
                        local v203 = u202
                        local v204 = u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v203:GetPivot().Position).Magnitude / 3)

                        u202.ChestEsp.TextLabel.Text = 'Chest\n' .. v204 .. ' M'
                    else
                        local _BillboardGui27 = Instance.new('BillboardGui', u202)

                        _BillboardGui27.Name = 'ChestEsp'
                        _BillboardGui27.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui27.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui27.Adornee = u202
            ...
            elseif u202:FindFirstChild('ChestEsp') then
                u202:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u211.Name, 'Fruit') then
                    if u211.Handle:FindFirstChild('NameEsp' .. Number) then
                        u211.Handle['NameEsp' .. Number].TextLabel.Text = u211.Name .. '   \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u211.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui28 = Instance.new('BillboardGui', u211.Handle)
                        ...
                        _BillboardGui28.Adornee = u211.Handle
                        ...
                        _TextLabel28.Text = u211.Name .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u211.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u211.Handle:FindFirstChild('NameEsp' .. Number) then
                u211.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u217.Name == 'Flower2' or u217.Name == 'Flower1' then
                if FlowerESP then
                    if u217:FindFirstChild('NameEsp' .. Number) then
                        u217['NameEsp' .. Number].TextLabel.Text = u217.Name .. '   \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u217.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui29 = Instance.new('BillboardGui', u217)
                        ...
                        if u217.Name == 'Flower1' then
                            _TextLabel29.Text = 'Blue Flower' .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u217.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel29.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u217.Name == 'Flower2' then
                            _TextLabel29.Text = 'Red Flower' .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u217.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel29.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u217:FindFirstChild('NameEsp' .. Number) then
                    u217:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v223:IsA('Tool') then
            if RealFruitESP then
                if v223.Handle:FindFirstChild('NameEsp' .. Number) then
                    v223.Handle['NameEsp' .. Number].TextLabel.Text = v223.Name .. ' ' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v223.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui30 = Instance.new('BillboardGui', v223.Handle)
                    ...
                    _BillboardGui30.Adornee = v223.Handle
                    ...
                    _TextLabel30.Text = v223.Name .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v223.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v229:IsA('Tool') then
            if RealFruitESP then
                if v229.Handle:FindFirstChild('NameEsp' .. Number) then
                    v229.Handle['NameEsp' .. Number].TextLabel.Text = v229.Name .. ' ' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v229.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui31 = Instance.new('BillboardGui', v229.Handle)
                    ...
                    _BillboardGui31.Adornee = v229.Handle
                    ...
                    _TextLabel31.Text = v229.Name .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v229.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v235:IsA('Tool') then
            if RealFruitESP then
                if v235.Handle:FindFirstChild('NameEsp' .. Number) then
                    v235.Handle['NameEsp' .. Number].TextLabel.Text = v235.Name .. ' ' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v235.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui32 = Instance.new('BillboardGui', v235.Handle)
                    ...
                    _BillboardGui32.Adornee = v235.Handle
                    ...
                    _TextLabel32.Text = v235.Name .. ' \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - v235.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u241.Name ~= 'Sea' then
                    if u241:FindFirstChild('NameEsp') then
                        u241.NameEsp.TextLabel.Text = u241.Name .. '   \n' .. u192((game:GetService('Players').LocalPlayer.Character.Head.Position - u241.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui33 = Instance.new('BillboardGui', u241)

                        _BillboardGui33.Name = 'NameEsp'
                        _BillboardGui33.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui33.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui33.Adornee = u241
            ...
            elseif u241:FindFirstChild('NameEsp') then
                u241:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u250.Character) then
                if ESPPlayer then
                    if isnil(u250.Character.Head) or u250.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u250.Character.Head['NameEsp' .. Number].TextLabel.Text = u250.Name .. ' | ' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u250.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u246(u250.Character.Humanoid.Health * 100 / u250.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui34 = Instance.new('BillboardGui', u250.Character.Head)
                        ...
                        _BillboardGui34.Adornee = u250.Character.Head
                        ...
                        _TextLabel34.Text = u250.Name .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u250.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u250.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel34.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel34.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u250.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u250.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u256:GetAttribute('IsDisabled') then
                    if u256:FindFirstChild('ChestEsp') then
                        local v257 = u256
                        local v258 = u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v257:GetPivot().Position).Magnitude / 3)

                        u256.ChestEsp.TextLabel.Text = 'Chest\n' .. v258 .. ' M'
                    else
                        local _BillboardGui35 = Instance.new('BillboardGui', u256)

                        _BillboardGui35.Name = 'ChestEsp'
                        _BillboardGui35.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui35.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui35.Adornee = u256
            ...
            elseif u256:FindFirstChild('ChestEsp') then
                u256:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u265.Name, 'Fruit') then
                    if u265.Handle:FindFirstChild('NameEsp' .. Number) then
                        u265.Handle['NameEsp' .. Number].TextLabel.Text = u265.Name .. '   \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u265.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui36 = Instance.new('BillboardGui', u265.Handle)
                        ...
                        _BillboardGui36.Adornee = u265.Handle
                        ...
                        _TextLabel36.Text = u265.Name .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u265.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u265.Handle:FindFirstChild('NameEsp' .. Number) then
                u265.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u271.Name == 'Flower2' or u271.Name == 'Flower1' then
                if FlowerESP then
                    if u271:FindFirstChild('NameEsp' .. Number) then
                        u271['NameEsp' .. Number].TextLabel.Text = u271.Name .. '   \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u271.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui37 = Instance.new('BillboardGui', u271)
                        ...
                        if u271.Name == 'Flower1' then
                            _TextLabel37.Text = 'Blue Flower' .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u271.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel37.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u271.Name == 'Flower2' then
                            _TextLabel37.Text = 'Red Flower' .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u271.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel37.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u271:FindFirstChild('NameEsp' .. Number) then
                    u271:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v277:IsA('Tool') then
            if RealFruitESP then
                if v277.Handle:FindFirstChild('NameEsp' .. Number) then
                    v277.Handle['NameEsp' .. Number].TextLabel.Text = v277.Name .. ' ' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v277.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui38 = Instance.new('BillboardGui', v277.Handle)
                    ...
                    _BillboardGui38.Adornee = v277.Handle
                    ...
                    _TextLabel38.Text = v277.Name .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v277.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v283:IsA('Tool') then
            if RealFruitESP then
                if v283.Handle:FindFirstChild('NameEsp' .. Number) then
                    v283.Handle['NameEsp' .. Number].TextLabel.Text = v283.Name .. ' ' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v283.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui39 = Instance.new('BillboardGui', v283.Handle)
                    ...
                    _BillboardGui39.Adornee = v283.Handle
                    ...
                    _TextLabel39.Text = v283.Name .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v283.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v289:IsA('Tool') then
            if RealFruitESP then
                if v289.Handle:FindFirstChild('NameEsp' .. Number) then
                    v289.Handle['NameEsp' .. Number].TextLabel.Text = v289.Name .. ' ' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v289.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui40 = Instance.new('BillboardGui', v289.Handle)
                    ...
                    _BillboardGui40.Adornee = v289.Handle
                    ...
                    _TextLabel40.Text = v289.Name .. ' \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - v289.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u295.Name ~= 'Sea' then
                    if u295:FindFirstChild('NameEsp') then
                        u295.NameEsp.TextLabel.Text = u295.Name .. '   \n' .. u246((game:GetService('Players').LocalPlayer.Character.Head.Position - u295.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui41 = Instance.new('BillboardGui', u295)

                        _BillboardGui41.Name = 'NameEsp'
                        _BillboardGui41.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui41.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui41.Adornee = u295
            ...
            elseif u295:FindFirstChild('NameEsp') then
                u295:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
function UpdatePlayerChams()
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u304.Character) then
                if ESPPlayer then
                    if isnil(u304.Character.Head) or u304.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u304.Character.Head['NameEsp' .. Number].TextLabel.Text = u304.Name .. ' | ' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u304.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u300(u304.Character.Humanoid.Health * 100 / u304.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui42 = Instance.new('BillboardGui', u304.Character.Head)
                        ...
                        _BillboardGui42.Adornee = u304.Character.Head
                        ...
                        _TextLabel42.Text = u304.Name .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u304.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u304.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel42.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel42.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u304.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u304.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestESP()
    ...
    while true do
        ...
        pcall(function()
            if _G.ChestESP then
                if not u310:GetAttribute('IsDisabled') then
                    if u310:FindFirstChild('ChestEsp') then
                        local v311 = u310
                        local v312 = u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v311:GetPivot().Position).Magnitude / 3)

                        u310.ChestEsp.TextLabel.Text = 'Chest\n' .. v312 .. ' M'
                    else
                        local _BillboardGui43 = Instance.new('BillboardGui', u310)

                        _BillboardGui43.Name = 'ChestEsp'
                        _BillboardGui43.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui43.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui43.Adornee = u310
            ...
            elseif u310:FindFirstChild('ChestEsp') then
                u310:FindFirstChild('ChestEsp'):Destroy()
            end
        end)
    end
end
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u319.Name, 'Fruit') then
                    if u319.Handle:FindFirstChild('NameEsp' .. Number) then
                        u319.Handle['NameEsp' .. Number].TextLabel.Text = u319.Name .. '   \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u319.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui44 = Instance.new('BillboardGui', u319.Handle)
                        ...
                        _BillboardGui44.Adornee = u319.Handle
                        ...
                        _TextLabel44.Text = u319.Name .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u319.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u319.Handle:FindFirstChild('NameEsp' .. Number) then
                u319.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    ...
    while true do
        ...
        pcall(function()
            if u325.Name == 'Flower2' or u325.Name == 'Flower1' then
                if FlowerESP then
                    if u325:FindFirstChild('NameEsp' .. Number) then
                        u325['NameEsp' .. Number].TextLabel.Text = u325.Name .. '   \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u325.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui45 = Instance.new('BillboardGui', u325)
                        ...
                        if u325.Name == 'Flower1' then
                            _TextLabel45.Text = 'Blue Flower' .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u325.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel45.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u325.Name == 'Flower2' then
                            _TextLabel45.Text = 'Red Flower' .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - u325.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel45.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u325:FindFirstChild('NameEsp' .. Number) then
                    u325:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
        ...
        if v331:IsA('Tool') then
            if RealFruitESP then
                if v331.Handle:FindFirstChild('NameEsp' .. Number) then
                    v331.Handle['NameEsp' .. Number].TextLabel.Text = v331.Name .. ' ' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v331.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui46 = Instance.new('BillboardGui', v331.Handle)
                    ...
                    _BillboardGui46.Adornee = v331.Handle
                    ...
                    _TextLabel46.Text = v331.Name .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v331.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v337:IsA('Tool') then
            if RealFruitESP then
                if v337.Handle:FindFirstChild('NameEsp' .. Number) then
                    v337.Handle['NameEsp' .. Number].TextLabel.Text = v337.Name .. ' ' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v337.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui47 = Instance.new('BillboardGui', v337.Handle)
                    ...
                    _BillboardGui47.Adornee = v337.Handle
                    ...
                    _TextLabel47.Text = v337.Name .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v337.Handle.Position).Magnitude / 3) .. ' Distance'
                end
        ...
        if v343:IsA('Tool') then
            if RealFruitESP then
                if v343.Handle:FindFirstChild('NameEsp' .. Number) then
                    v343.Handle['NameEsp' .. Number].TextLabel.Text = v343.Name .. ' ' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v343.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui48 = Instance.new('BillboardGui', v343.Handle)
                    ...
                    _BillboardGui48.Adornee = v343.Handle
                    ...
                    _TextLabel48.Text = v343.Name .. ' \n' .. u300((game:GetService('Players').LocalPlayer.Character.Head.Position - v343.Handle.Position).Magnitude / 3) .. ' Distance'
                end
    ...
    while true do
        ...
        pcall(function()
            if MirageIslandESP then
                if u385.Name == 'Mirage Island' then
                    if u385:FindFirstChild('NameEsp') then
                        u385.NameEsp.TextLabel.Text = u385.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u385.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui52 = Instance.new('BillboardGui', u385)

                        _BillboardGui52.Name = 'NameEsp'
                        _BillboardGui52.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui52.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui52.Adornee = u385
            ...
            elseif u385:FindFirstChild('NameEsp') then
                u385:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
    ...
    while true do
        ...
        pcall(function()
            if PrehistoricIslandESP then
                if u391.Name == 'PrehistoricIsland' then
                    if u391:FindFirstChild('NameEsp') then
                        u391.NameEsp.TextLabel.Text = u391.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u391.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui53 = Instance.new('BillboardGui', u391)

                        _BillboardGui53.Name = 'NameEsp'
                        _BillboardGui53.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui53.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui53.Adornee = u391
            ...
            elseif u391:FindFirstChild('NameEsp') then
                u391:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateAfdESP()
    ...
    while true do
        ...
        pcall(function()
            if AfdESP then
                if u397.Name == 'Advanced Fruit Dealer' then
                    if u397:FindFirstChild('NameEsp') then
                        u397.NameEsp.TextLabel.Text = u397.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u397.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui54 = Instance.new('BillboardGui', u397)

                        _BillboardGui54.Name = 'NameEsp'
                        _BillboardGui54.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui54.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui54.Adornee = u397
            ...
            elseif u397:FindFirstChild('NameEsp') then
                u397:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateAuraESP()
    ...
    while true do
        ...
        pcall(function()
            if AuraESP then
                if u403.Name == 'Master of Enhancement' then
                    if u403:FindFirstChild('NameEsp') then
                        u403.NameEsp.TextLabel.Text = u403.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u403.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui55 = Instance.new('BillboardGui', u403)

                        _BillboardGui55.Name = 'NameEsp'
                        _BillboardGui55.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui55.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui55.Adornee = u403
            ...
            elseif u403:FindFirstChild('NameEsp') then
                u403:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateLSDESP()
    ...
    while true do
        ...
        pcall(function()
            if LADESP then
                if u409.Name == 'Legendary Sword Dealer' then
                    if u409:FindFirstChild('NameEsp') then
                        u409.NameEsp.TextLabel.Text = u409.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u409.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui56 = Instance.new('BillboardGui', u409)

                        _BillboardGui56.Name = 'NameEsp'
                        _BillboardGui56.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui56.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui56.Adornee = u409
            ...
            elseif u409:FindFirstChild('NameEsp') then
                u409:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
function InfAb()
    if InfAbility then
        if not game:GetService('Players').LocalPlayer.Character.HumanoidRootPart:FindFirstChild('Agility') then
            ...
            _ParticleEmitter.Size = NumberSequence.new(v413)
...
function UpdateGeaESP()
    ...
    while true do
        ...
        pcall(function()
            if GearESP then
                if u417.Name == 'MeshPart' then
                    if u417:FindFirstChild('NameEsp') then
                        u417.NameEsp.TextLabel.Text = u417.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u417.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui57 = Instance.new('BillboardGui', u417)

                        _BillboardGui57.Name = 'NameEsp'
                        _BillboardGui57.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui57.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui57.Adornee = u417
            ...
            elseif u417:FindFirstChild('NameEsp') then
                u417:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateBerriesESP()
    ...
    local v421, v422, v423 = pairs(_BerryBush)

    while true do
        local u424

        v423, u424 = v421(v422, v423)
        ...
        pcall(function()
            ...
            while true do
                ...
                if v429 then
                    if not u424.Parent:FindFirstChild('BerryESP') then
                        local _BillboardGui58 = Instance.new('BillboardGui', u424.Parent)

                        _BillboardGui58.Name = 'BerryESP'
                        _BillboardGui58.ExtentsOffset = Vector3.new(0, 2, 0)
                        _BillboardGui58.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui58.Adornee = u424.Parent
                        ...
                        _TextLabel58.Text = v429
                    end
                    if u424.Parent:FindFirstChild('BerryESP') then
                        ...
                        if _LocalPlayer and _LocalPlayer.Character and _LocalPlayer.Character:FindFirstChild('Head') then
                            ...
                            local _Magnitude = (u424.Parent:GetPivot().Position - _Position).Magnitude

                            u424.Parent.BerryESP.TextLabel.Text = v429 .. '\n' .. math.floor(_Magnitude) .. 'm'
                        end
                    end
                elseif u424.Parent:FindFirstChild('NameEsp') then
                    u424.Parent:FindFirstChild('NameEsp'):Destroy()
                end
            end
        end)
    end
    ...
    while true do
        ...
        pcall(function()
            if KitsuneIslandEsp then
                if u438.Name == 'Kitsune Island' then
                    if u438:FindFirstChild('NameEsp') then
                        u438.NameEsp.TextLabel.Text = u438.Name .. '   \n' .. u381((game:GetService('Players').LocalPlayer.Character.Head.Position - u438.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui59 = Instance.new('BillboardGui', u438)

                        _BillboardGui59.Name = 'NameEsp'
                        _BillboardGui59.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui59.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui59.Adornee = u438
            ...
            elseif u438:FindFirstChild('NameEsp') then
                u438:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function AutoHaki()
    ...
    local v442 = _Character and not _Character:FindFirstChild('HasBuso') and game:GetService('ReplicatedStorage').Remotes.CommF_
...
spawn(function()
    ...
    local ___namecall = v445.__namecall
    ...
    v445.__namecall = newcclosure(function(...)
        ...
        return ___namecall(unpack(v448))
    end)
end)
spawn(function()
    pcall(function()
...
function LockTween()
    if not _G.LockTween then
        ...
        local v456 = _Character3 and _Character3:IsDescendantOf(game.Workspace) and _Character3:WaitForChild('HumanoidRootPart')
    ...
    while true do
        ...
        if v461.Name == p457 and (v461.Parent and (v461:FindFirstChild('HumanoidRootPart') and (v461:FindFirstChild('Humanoid') and (v461.Humanoid.Health > 0 and (v461.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 350)))) then
            ...
            if not v461.HumanoidRootPart:FindFirstChild('Lock') then
                ...
                _BodyVelocity.Parent = v461.HumanoidRootPart
...
function KillMob(p463, p464)
    pcall(function()
        thismob = DetectMob2(p463)
        ...
        if thismob:FindFirstChild('HumanoidRootPart') and thismob.Parent and (thismob:FindFirstChild('Humanoid') and thismob.Humanoid.Health > 0) then
            repeat
                ...
                NoClip = true
            until not thismob.Parent or (not thismob:FindFirstChild('Humanoid') or (thismob:FindFirstChild('Humanoid').Health <= 0 or (not thismob:FindFirstChild('HumanoidRootPart') or p464())))
...
function CheckNearestTeleporter(p487)
    local _Position2 = p487.Position
    ...
    while true do
        ...
        local _Magnitude2 = (v497 - _Position2).Magnitude
...
function topos(p502)
    ...
    if _LocalPlayer2.Character and _LocalPlayer2.Character.Humanoid.Health > 0 and _LocalPlayer2.Character:FindFirstChild('HumanoidRootPart') then
        local _Magnitude3 = (p502.Position - _LocalPlayer2.Character.HumanoidRootPart.Position).Magnitude
        ...
        if not _LocalPlayer2.Character:FindFirstChild('PartTele') then
            ...
            _Part.GetPropertyChangedSignal(v507, 'CFrame'):Connect(function()
                if u485 then
                    task.wait()

                    if _LocalPlayer2.Character and _LocalPlayer2.Character:FindFirstChild('HumanoidRootPart') then
                        WaitHRP(_LocalPlayer2).CFrame = _Part.CFrame
                    end
                end
            end)
        end
        ...
        local v508 = game:GetService('TweenService'):Create(_LocalPlayer2.Character.PartTele, TweenInfo.new(_Magnitude3 / 360, Enum.EasingStyle.Linear), {CFrame = p502})
...
_LocalPlayer5.CharacterAdded:Connect(v514)

if _LocalPlayer5.Character then
    v514(_LocalPlayer5.Character)
end
...
function TP13(p522)
    local _Magnitude4 = (p522.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    local u524 = game:GetService('TweenService'):Create(game:GetService('Players').LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(_Magnitude4 / TweenSpeed, Enum.EasingStyle.Linear), {CFrame = p522}):Play()

    function u521.Stop(_)
        u524:Cancel()
    end
...
function fastpos(p525)
    ...
    game:GetService('TweenService'):Create(game:GetService('Players').LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / Speed, Enum.EasingStyle.Linear), {CFrame = p525}):Play()
end
function slowpos(p526)
    Distance = (p526.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    Speed = 150

    game:GetService('TweenService'):Create(game:GetService('Players').LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / Speed, Enum.EasingStyle.Linear), {CFrame = p526}):Play()
end
function BTP(p527)
    pcall(function()
        if (p527.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 1500 and (not Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0) then
            repeat
                wait()

                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p527

                wait(0.05)
                game.Players.LocalPlayer.Character.Head:Destroy()

                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p527
            until (p527.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 1500 and game.Players.LocalPlayer.Character.Humanoid.Health > 0
        end
    end)
end
...
function TPB(p529)
    ...
    tween = _TweenService:Create(game:GetService('Workspace').Boats.PirateBrigade.VehicleSeat, v531, {CFrame = p529})
...
function TPP(p532)
    if game.Players.LocalPlayer.Character:WaitForChild('Humanoid').Health > 0 and game:GetService('Players').LocalPlayer.Character:WaitForChild('Humanoid') then
        ...
        tween = _TweenService2:Create(game.Players.LocalPlayer.Character.HumanoidRootPart, v534, {CFrame = p532})
...
local u577 = loadstring(game:HttpGet('https://raw.githubusercontent.com/AnhDangNhoEm/UiRedz/refs/heads/main/RedzUiV.txt'))():MakeWindow({
...
_ImageButton.Image = 'rbxassetid://75774010417827'
...
local function u591(p589)
    local v590 = p589.Position - u587

    _ImageButton.Position = UDim2.new(u588.X.Scale, u588.X.Offset + v590.X, u588.Y.Scale, u588.Y.Offset + v590.Y)
end

_ImageButton.InputBegan:Connect(function(p592)
    if p592.UserInputType == Enum.UserInputType.Touch or p592.UserInputType == Enum.UserInputType.MouseButton1 then
        u585 = true
        u587 = p592.Position
        u588 = _ImageButton.Position

        p592.Changed:Connect(function()
            if p592.UserInputState == Enum.UserInputState.End then
                u585 = false
            end
        end)
    end
end)
_ImageButton.InputChanged:Connect(function(p593)
...
local v595 = u577
local v596 = u577.MakeTab(v595, {
    'Th\u{f4}ng Tin | Info',
    'info',
})
local v597 = u577
local v598 = u577.MakeTab(v597, {
    'Farming',
    'home',
})
local v599 = u577
local v600 = u577.MakeTab(v599, {
    'Auto Fishing',
    'rbxassetid://127664059821666',
})
local v601 = u577
local v602 = u577.MakeTab(v601, {
    'Quest | Items',
    'swords',
})
local v603 = u577
local v604 = u577.MakeTab(v603, {
    'Volcano Dojo',
    'cake',
})
local v605 = u577
local v606 = u577.MakeTab(v605, {
    'Sea Event',
    'waves',
})
local v607 = u577
local v608 = u577.MakeTab(v607, {
    'Race V4',
    'crown',
})
local v609 = u577
local v610 = u577.MakeTab(v609, {
    'Raid Fruits',
    'cherry',
})
local v611 = u577
local v612 = u577.MakeTab(v611, {
    'Fruits | Check Stock',
    'apple',
})
local v613 = u577
local v614 = u577.MakeTab(v613, {
    'Teleport',
    'locate',
})
local v615 = u577
local v616 = u577.MakeTab(v615, {
    'PvP,Player',
    'user',
})
local v617 = u577
local v618 = u577.MakeTab(v617, {
    'Shop',
    'shoppingCart',
})
local v619 = u577
local v620 = u577.MakeTab(v619, {
    'Settings',
    'settings',
})
...
v596:AddDiscordInvite({
    Name = 'Tu\u{1ea5}n Anh (T\u{fa}nnAngg)',
    Description = 'Facebook C\u{1ee7}a B\u{1ed1} \u{110}\u{e2}y Nh\u{f3}c',
    Logo = 'rbxassetid://110657725541747',
    Invite = 'https://www.facebook.com/tuananhiosdz',
})
v596:AddDiscordInvite({
    Name = 'Tu\u{1ea5}n Anh IOS',
    Description = 'YouTube C\u{1ee7}a B\u{1ed1} \u{110}\u{e2}y Nh\u{f3}c',
    Logo = 'rbxassetid://110657725541747',
    Invite = 'https://www.youtube.com/@tuananhios',
})
v596:AddDiscordInvite({
    Name = 'Tu\u{1ea5}n Anh IOS',
    Description = 'TikTok C\u{1ee7}a B\u{1ed1} \u{110}\u{e2}y Nh\u{f3}c',
    Logo = 'rbxassetid://110657725541747',
...
function CheckQuestNew()
    ...
    elseif 2625 <= _Value and _Value <= 2649 then
        MonNew = 'Coral Pirate'
        LevelQuestNew = 2
        NameQuestNew = 'SubmergedQuest1'
    ...
    elseif 2650 <= _Value and _Value <= 2674 then
        MonNew = 'Sea Chanter'
        LevelQuestNew = 1
                ...
                while true do
                    ...
                    if v654.Name == MonNew and (v654:FindFirstChild('HumanoidRootPart') and (v654:FindFirstChild('Humanoid') and v654.Humanoid.Health > 0)) then
                        if string.find(_Quest.Container.QuestTitle.Title.Text, NameMonNew) then
                            ...
                            if _G.AutoFarmLevelNew and (v654.Humanoid.Health > 0 and (v654.Parent and _Quest.Visible ~= false)) then
                            end
                        else
                            StartBring = false
...
v598:AddToggle({
    ...
    Description = 'T\u{1ef1} \u{110}\u{1ed9}ng Di Chuy\u{1ec3}n \u{110}\u{1ebf}n V\u{1ecb} Tr\u{ed} Summer Token Theo Sea V\u{e0} Farm Qu\u{e1}i [Electrified]',
    Default = false,
    ...
    pcall(function()
        if type(topos) ~= 'function' then
            ...
            if _LocalPlayer6 and _LocalPlayer6.Character and _LocalPlayer6.Character:FindFirstChild('HumanoidRootPart') then
                _LocalPlayer6.Character.HumanoidRootPart.CFrame = p661
            end
        else
            topos(p661)
        end
...
local function u665()
    ...
    elseif _PlaceId3 == 7449423635 then
    ...
    while task.wait() do
        if _G.FarmSummer then
            pcall(function()
                ...
                u663(_HumanoidRootPart4.CFrame * CFrame.new(0, 30, 0))
                game:GetService('VirtualUser'):CaptureController()
                game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))

                if _G.FarmSummer and (v670.Parent and _Humanoid.Health > 0) then
                end
                ...
                local _Humanoid = v670:FindFirstChild('Humanoid')
                local _HumanoidRootPart4 = v670:FindFirstChild('HumanoidRootPart')
...
task.spawn(function()
    while task.wait(1) do
        pcall(function()
            ...
            u686:Set('Status: ' .. v691 .. ' Eye(s)' .. (v691 == 4 and ' \u{fffd}\u{fffd}\u{fffd}\u{fffd}\u{fffd}\u{fffd}' or ''))
        end)
    end
end)
v598:AddToggle({
...
local u694 = CFrame.new(-16194.0048828125, 155.21844482421875, 1420.719970703125)
        ...
        if _G.FarmDaiBan then
            pcall(function()
                ...
                if not v702 then
                    ...
                    if BypassTP then
                        if (playerPos - u694.Position).Magnitude <= 1500 then
                            topos(u694)
                        else
                            BTP(u694)
                        end
                ...
                if true then
                    ...
                    if v708.Name ~= 'Isle Outlaw' then
                        if v708.Name ~= 'Island Boy' then
                            ...
                            Bring(v708.Name, CFrame.new(-16901.26171875, 84.06756591796875, -192.88906860351563))
                        end
                    else
...
function TweenToPosition(p711)
    ...
    if _Character6 then
        ...
        local v714 = (_Character6.Position - p711.Position).Magnitude / 300
        local v715 = _TweenService3:Create(_Character6, TweenInfo.new(v714, Enum.EasingStyle.Linear), {CFrame = p711})
...
function Skill(p716)
    ...
    _VirtualInputManager:SendKeyEvent(true, Enum.KeyCode[p716], false, game)
    task.wait(0.05)
    _VirtualInputManager:SendKeyEvent(false, Enum.KeyCode[p716], false, game)
end
function Click()
...
function FindWeapon(p719)
    ...
    local v721, v722, v723 = ipairs(_Backpack:GetChildren())
...
function EquipWeapon(p725)
    if p725 then
        ...
        local v727 = _LocalPlayer7:WaitForChild('Backpack'):FindFirstChild(p725)

        if v727 then
            _LocalPlayer7.Character.Humanoid:EquipTool(v727)
        end
    end
end
...
task.spawn(function()
    while task.wait(1) do
        if _G.Farm8Binhs then
            local v732, v733, v734 = ipairs(u710)
...
task.spawn(function()
    while task.wait(1) do
        pcall(function()
            ...
            u736:Set('You Have: ' .. tostring(_Bones) .. ' Bones')
        end)
    end
end)
v598:AddToggle({
...
spawn(function()
    while wait() do
        local u739 = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)

        if _G.FarmBone and World3 then
            pcall(function()
                if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u739.Position).Magnitude <= 2000 then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u739.Position).Magnitude < 2000 then
                            TP1(u739)
                        end
                    else
                        ...
                        for _ = 1, 8 do
                            game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(u739)
        ...
        pcall(function()
            ...
            if string.len(_CakePrinceSpawner) ~= 88 then
                if string.len(_CakePrinceSpawner) ~= 87 then
                    if string.len(_CakePrinceSpawner) ~= 86 then
                        u756:Set('Prince King Spawned \u{2705}')
                    else
                        u756:Set('Killed : ' .. string.sub(_CakePrinceSpawner, 39, 39) .. ' / 500')
                    end
                else
                    u756:Set('Killed : ' .. string.sub(_CakePrinceSpawner, 39, 40) .. ' / 500')
                end
            else
                u756:Set('Killed : ' .. string.sub(_CakePrinceSpawner, 39, 41) .. ' / 500')
            end
        end)
    end
end)
...
local u759 = CFrame.new(-2130.80712890625, 69.95634460449219, -12327.83984375)
local _ = game:GetService('Workspace').Enemies
        ...
        if _G.FarmCake then
            pcall(function()
                ...
                if not v763 then
                    ...
                    if BypassTP then
                        if (playerPos - u759.Position).Magnitude <= 1500 then
                            topos(u759)
                        else
                            BTP(u759)
                        end
...
spawn(function()
    while wait() do
        if _G.CollectBerry then
            ...
            local v792, v793, v794 = ipairs(_BerryBush2)
            local v795 = nil
            local v796 = nil
            ...
            while true do
                ...
                while true do
                    ...
                    local _Magnitude5 = (v797.Parent:GetPivot().Position - _Position3).Magnitude
...
spawn(function()
    while wait() do
        if _G.FarmChest then
            ...
            for v813 = 1, #__ChestTagged do
                local v814 = __ChestTagged[v813]
                local _Magnitude6 = (v814:GetPivot().Position - _Position5).Magnitude
            ...
            if v812 then
                local _Position6 = v812:GetPivot().Position
                local v817 = CFrame.new(_Position6)
    ...
    while task.wait(1) do
        pcall(function()
            if _G.SelectBoss and (game:GetService('ReplicatedStorage'):FindFirstChild(_G.SelectBoss) or game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss)) then
                u818:Set('Status: Boss Spawn \u{2705}')
            else
                u818:Set('Status: Boss Not Spawn \u{274c}')
            end
        end)
    end
end)
...
local u843 = require(game.ReplicatedStorage.Util.GetWaterHeightAtLocation)
...
task.spawn(function()
    while task.wait() do
        if _G.AutoFishing then
            ...
            if _Character7 then
                v845 = _Character7:FindFirstChild('HumanoidRootPart')
            else
                v845 = _Character7
            end
            ...
            if _Character7 then
                v846 = _Character7:FindFirstChildOfClass('Tool')
            else
                v846 = _Character7
            end
            ...
            if _G.SelectedRod and (not v846 or v846.Name ~= _G.SelectedRod) then
                v847 = _LocalPlayer10.Backpack:FindFirstChild(_G.SelectedRod)

                if v847 then
                    _LocalPlayer10.Character.Humanoid:EquipTool(v847)
                else
                    v847 = v846
                end
            else
            ...
            if _Character7 and (v845 and v847) then
                local v848 = u843(v845.Position)
                local _, v849 = workspace:FindPartOnRayWithIgnoreList(Ray.new(_Character7.Head.Position, v845.CFrame.LookVector * _MaxLaunchDistance), {
                    _Character7,
                ...
                local _State = v847:GetAttribute('State')
                local _ServerState = v847:GetAttribute('ServerState')

                if (_State == 'ReeledIn' or _ServerState == 'ReeledIn') and v849 then
                    _FishingRequest:InvokeServer('StartCasting')
                    task.wait()
                    _FishingRequest:InvokeServer('CastLineAtLocation', v849, 100, true)
...
v600:AddDropdown({
    ...
    Callback = function(p852)
        ...
        _FishingRequest:InvokeServer('SelectBait', p852)
    end,
})
v600:AddDropdown({
...
if World1 then
    ...
    local u880 = CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094)
            ...
            if _G.Autosaw then
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('The Saw') then
                        ...
                        if BypassTP then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u880.Position).Magnitude <= 1500 then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u880.Position).Magnitude < 1500 then
                                    topos(u880)
                                end
                            else
                    ...
                    elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Swan Pirates') and (string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, '50') and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true) then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Swan Pirate') then
                            ...
                            while true do
                                ...
                                v902, u903 = v900(v901, v902)

                                if v902 == nil then
                                    break
                                end
                                if u903.Name == Ms then
                                    pcall(function()
                                        repeat
                                            task.wait()
                                            sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                            ...
                                            u903.HumanoidRootPart.Transparency = 1
                                            u903.HumanoidRootPart.CanCollide = false
                                            u903.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                            topos(u903.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))

                                            PosMonBarto = u903.HumanoidRootPart.CFrame

                                            game:GetService('VirtualUser'):CaptureController()
                                            game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))

                                            StartBring = true
                                        until not u903.Parent or (u903.Humanoid.Health <= 0 or _G.AutoBartilo == false) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false
...
if World3 then
    ...
    local u952 = CFrame.new(-5344.822265625, 423.98541259766, -2725.0930175781)
                ...
                if _G.RipIndraKill then
                    if game:GetService('Workspace').Enemies:FindFirstChild('rip_indra True Form') or game:GetService('Workspace').Enemies:FindFirstChild('rip_indra') then
                        ...
                        while true do
                            ...
                            v955, u956 = v953(v954, v955)

                            if v955 == nil then
                                break
                            end
                            if u956.Name == ('rip_indra True Form' or u956.Name == 'rip_indra') and (u956.Humanoid.Health > 0 and (u956:IsA('Model') and (u956:FindFirstChild('Humanoid') and u956:FindFirstChild('HumanoidRootPart')))) then
                                repeat
                                    task.wait()
                                    pcall(function()
                                        AutoHaki()
                                        ...
                                        u956.HumanoidRootPart.CanCollide = false
                                        u956.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        topos(u956.HumanoidRootPart.CFrame * CFrame.new(0, -40, 0))
                                        game:GetService('VirtualUser'):CaptureController()
                                        game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 670), workspace.CurrentCamera.CFrame)
                                    end)
                                until _G.RipIndraKill == false or u956.Humanoid.Health <= 0
                            end
                        end
                    else
                        if BypassTP then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u952.Position).Magnitude <= 1500 then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u952.Position).Magnitude < 1500 then
                                    TP1(u952)
                                end
                            else
                            ...
                            if game:GetService('Workspace').NPCs:FindFirstChild('Skeleton Machine') then
                                ...
                                if _HauntedCastle and _HauntedCastle.Candle1.Transparency == 0 then
                                    ...
                                    if _Placard1 and _Placard1.Left.Part.Transparency == 0 then
                                        ...
                                        for v963 = 7, 1, -1 do
                                            local v964 = _HauntedCastle:FindFirstChild('Placard' .. v963)
                                ...
                                elseif _HauntedCastle and _HauntedCastle.Tablet and _HauntedCastle.Tablet:FindFirstChild('Segment1') then
                                    ...
                                    if _LabPuzzle and _LabPuzzle.ColorFloor.Model.Part1:FindFirstChild('ClickDetector') then
                                        ...
                                        while true do
                                            ...
                                            local v970 = _LabPuzzle.ColorFloor.Model:FindFirstChild('Part' .. v969)
                                    ...
                                    if _Enemies and _Enemies:FindFirstChild('Living Zombie') then
                                        local v972, v973, v974 = pairs(_Enemies:GetChildren())
                                        ...
                                        while true do
                                            ...
                                            if v975:FindFirstChild('HumanoidRootPart') and (v975:FindFirstChild('Humanoid') and (v975.Humanoid.Health > 0 and v975.Name == 'Living Zombie')) then
                                                ...
                                                v975.HumanoidRootPart.CFrame = _Character8.CFrame * CFrame.new(0, 20, 0)
...
function checkQuesta()
    ...
    local _, _ = pcall(function()
        u1019 = game:GetService('ReplicatedStorage').Modules.Net['RF/DragonHunter']:InvokeServer(unpack(u1018))
    end)
    local v1021 = nil
    local v1022 = nil
    local v1023 = nil
    ...
    if u1019 and u1019.Text then
        v1024 = true

        local _Text2 = u1019.Text

        if string.find(_Text2, 'Defeat') then
            v1022 = tonumber(string.sub(_Text2, 8, 9))
            ...
            while true do
                ...
                if string.find(_Text2, v1025) then
                    break
                end
            end
        ...
        if _G.FarmBlazeEM then
            pcall(function()
                ...
                if v1041 and not BackTODoJo() then
                    ...
                    local u1044 = v1043 == 2 and workspace.Map.Waterfall.IslandModel:FindFirstChild('Meshes/bambootree', true)
                    ...
                    while true do
                        task.wait()
                        spawn(function()
                            topos(u1044.CFrame * CFrame.new(4, 0, 0))
                        end)

                        if (u1044.Position - Root.Position).Magnitude <= 200 then
                            MousePos = u1044.Position
    ...
    while task.wait(1) do
        pcall(function()
            if game:GetService('Workspace').Map:FindFirstChild('PrehistoricIsland') then
                u1045:Set('Prehistoric Island Spawning \u{2705}')
            else
                u1045:Set('Prehistoric Island Not Spawn \u{274c}')
            end
        end)
    end
end)
...
_RunService.RenderStepped:Connect(function()
    local v1053, v1054, v1055 = pairs(u1047)
    ...
    if _G.AutoFindPrehistoric then
        ...
        if _Character10 and _Character10:FindFirstChild('Humanoid') then
            local function v1064()
                ...
                local v1060, v1061, v1062 = pairs(u1047)
            ...
            local v1066, v1067, v1068 = pairs(_Workspace2.Boats:GetChildren())
            local v1069 = false
            local v1070 = nil
            ...
            while true do
                ...
                local _VehicleSeat = v1071:FindFirstChild('VehicleSeat')

                if _VehicleSeat and _VehicleSeat.Occupant == _Humanoid2 then
                    u1047[v1071.Name] = _VehicleSeat
                    v1070 = _VehicleSeat
                    v1069 = true
            ...
            if v1069 then
                ...
                local v1073, v1074, v1075 = pairs(_Workspace2.Boats:GetDescendants())
                ...
                local v1077, v1078, v1079 = pairs(_Character10:GetDescendants())
                ...
                while true do
                    ...
                    local v1085 = _Workspace2.Map:FindFirstChild(v1084)
...
spawn(function()
    ...
    while wait() do
        ...
        if v1088 then
            local _Core = v1088:FindFirstChild('Core')

            if _Core then
                _Core = v1088.Core:FindFirstChild('PrehistoricRelic')
            end
            if _Core then
...
local function u1107()
    ...
    if _PrehistoricIsland then
        local v1095, v1096, v1097 = pairs(_PrehistoricIsland:GetDescendants())
    ...
    if _PrehistoricIsland then
        local v1099, v1100, v1101 = pairs(_PrehistoricIsland:GetDescendants())
...
local function u1115()
    local _VolcanoRocks = game.Workspace.Map.PrehistoricIsland.Core.VolcanoRocks
    local v1109, v1110, v1111 = pairs(_VolcanoRocks:GetChildren())
    ...
    while true do
        ...
        if v1112:IsA('Model') then
            local _volcanorock = v1112:FindFirstChild('volcanorock')
...
local function u1127(p1116)
    ...
    while true do
        ...
        if v1122:IsA('Tool') and v1122.ToolTip == p1116 then
            v1122.Parent = _LocalPlayer13.Character
    ...
    pcall(function()
        while wait() do
            if _G.Kill_Aura then
                ...
                local v1142 = _LocalPlayer14.Character and _LocalPlayer14.Character:FindFirstChild('HumanoidRootPart')

                if v1142 then
                    v1142 = _LocalPlayer14.Character.HumanoidRootPart.Position
                end
                if v1142 then
                    ...
                    while true do
                        ...
                        v1145, u1146 = v1143(v1144, v1145)

                        if v1145 == nil then
                            break
                        end
                        if u1146:FindFirstChild('Humanoid') and (u1146:FindFirstChild('HumanoidRootPart') and (u1146.Humanoid.Health > 0 and (u1146.HumanoidRootPart.Position - v1142).Magnitude <= 1000)) then
                            pcall(function()
                                repeat
                                    wait()
                                    sethiddenproperty(_LocalPlayer14, 'SimulationRadius', math.huge)

                                    u1146.Humanoid.Health = 0
                                    u1146.HumanoidRootPart.CanCollide = false
                                until not _G.Kill_Aura or (not u1146.Parent or u1146.Humanoid.Health <= 0)
                            end)
                        end
                    end
                end
    ...
    while task.wait(1) do
        pcall(function()
            if game:GetService('Workspace').Map:FindFirstChild('KitsuneIsland') then
                u1153:Set('Kitsune Island Spawning \u{2705}')
            else
                u1153:Set('Kitsune Island Not Spawn \u{274c}')
            end
        end)
    end
end)
...
spawn(function()
    ...
    while wait() do
        if _G.TweenToKitsune then
            local _ShrineActive = v1155:FindFirstChild('ShrineActive')

            if _ShrineActive then
                local v1157, v1158, v1159 = pairs(_ShrineActive:GetDescendants())
    ...
    while task.wait(1) do
        pcall(function()
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                u1223:Set('Mirage Island Spawning \u{2705}')
            else
                u1223:Set('Mirage Island Not Spawn \u{274c}')
            end
        end)
    end
end)
            ...
            if _G.AutoQuestRace then
                if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Human' then
                            ...
                            if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Cyborg' then
                                if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Ghoul' then
                                    ...
                                    while true do
                                        ...
                                        v1247, u1248 = v1245(v1246, v1247)

                                        if v1247 == nil then
                                            break
                                        end
                                        if u1248:FindFirstChild('Humanoid') and (u1248:FindFirstChild('HumanoidRootPart') and u1248.Humanoid.Health > 0) then
                                            pcall(function()
                                                repeat
                                                    wait(0.1)

                                                    u1248.Humanoid.Health = 0
                                                    u1248.HumanoidRootPart.CanCollide = false

                                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                                until not _G.AutoQuestRace or (not u1248.Parent or u1248.Humanoid.Health <= 0)
                                            end)
                                        end
                                    end
                                end
                    ...
                    while true do
                        ...
                        v1275, u1276 = v1273(v1274, v1275)

                        if v1275 == nil then
                            break
                        end
                        if u1276:FindFirstChild('Humanoid') and (u1276:FindFirstChild('HumanoidRootPart') and u1276.Humanoid.Health > 0) then
                            pcall(function()
                                repeat
                                    wait(0.1)

                                    u1276.Humanoid.Health = 0
                                    u1276.HumanoidRootPart.CanCollide = false

                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until not _G.AutoQuestRace or (not u1276.Parent or u1276.Humanoid.Health <= 0)
                            end)
                        end
                    end
                end
...
local function u1306()
    ...
    while true do
        ...
        if u1301(v1305) and (u1301(v1305).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4500 then
            return u1301(v1305)
        end
    end
end
local function u1316()
...
task.spawn(function()
    while task.wait() do
        if _G.Dungeon then
            ...
            if u1306() then
                topos(u1306().CFrame * CFrame.new(0, 60, 0))
            end
        end
    end
end)
    ...
    while task.wait(0.2) do
        if getgenv().AutoStoreFruit then
            pcall(function()
                ...
                local v1326 = _LocalPlayer16.Character or _LocalPlayer16.CharacterAdded:Wait()
                ...
                while true do
                    ...
                    local v1332 = v1331[1]
                    local v1333 = v1331[2]
                    local v1334 = _Backpack4:FindFirstChild(v1332) or v1326:FindFirstChild(v1332)
...
local function u1368()
    ...
    if v1351 and v1352 then
        ...
        if not v1356 then
            v1350 = v1350 .. '- Kh\u{f4}ng c\u{f3} tr\u{e1}i n\u{e0}o.\n'
        end
    else
        v1350 = v1350 .. '- \u{274c} L\u{1ed7}i khi l\u{1ea5}y d\u{1eef} li\u{1ec7}u.\n'
    end
    ...
    if v1360 and v1361 then
        ...
        if not v1365 then
            v1359 = v1359 .. '- Kh\u{f4}ng c\u{f3} tr\u{e1}i n\u{e0}o.\n'
        end
    else
        v1359 = v1359 .. '- \u{274c} L\u{1ed7}i khi l\u{1ea5}y d\u{1eef} li\u{1ec7}u.\n'
    end

    return v1359
end

local u1369 = v612:AddParagraph({
    ...
    pcall(function()
        if type(topos) ~= 'function' then
            ...
            if _LocalPlayer17 and _LocalPlayer17.Character and _LocalPlayer17.Character:FindFirstChild('HumanoidRootPart') then
                _LocalPlayer17.Character.HumanoidRootPart.CFrame = p1370
            end
        else
            topos(p1370)
        end
                                    ...
                                    if _G.SelectIsland ~= 'MarineFord' then
                                        if _G.SelectIsland ~= 'Colosseum' then
                                            if _G.SelectIsland ~= 'Sky Island 1' then
                                                                                                                                    ...
                                                                                                                                    if _G.SelectIsland ~= 'Forgotten Island' then
                                                                                                                                        if _G.SelectIsland ~= 'Ussop Island' then
                                                                                                                                            if _G.SelectIsland == 'Mini Sky Island' or _G.SelectIsland == 'MiniSky' then
                                                                                                                                                u1372(CFrame.new(-288.741, 49326.316, -35248.594))
                                                                                                                                                                                        ...
                                                                                                                                                                                        if _G.SelectIsland ~= 'Candy Island' then
                                                                                                                                                                                            if _G.SelectIsland ~= 'Tiki Outpost' then
                                                                                                                                                                                                if _G.SelectIsland == 'Dragon Dojo' then
                                                                                                                                                                                                    u1372(CFrame.new(5743.319, 1206.91, 936.011))
                                                                                                                                                                                                end
                                                                                                                                                                                            else
                                                                                                                                                                                                u1372(CFrame.new(-16218.683, 9.086, 445.618))
                                                                                                                                                                                            end
                                                                                                                                                                                        else
                                                                                                                                                                                            u1372(CFrame.new(-1014.424, 149.111, -14555.963))
                                                                                                                                                                                        end
                                                                                                                                                                                    else
                                                                                                                                                                                        u1372(CFrame.new(87.943, 73.555, -12319.465))
                                                                                                                                                                                    end
                                                                                                                                                                                else
                                                                                                                                                                                    u1372(CFrame.new(-1884.775, 19.328, -11666.897))
                                                                                                                                                                                end
                                                                                                                                                                            else
                                                                                                                                                                                u1372(CFrame.new(-2062.748, 50.474, -10232.568))
                                                                                                                                                                            end
                                                                                                                                                                        else
                                                                                                                                                                            u1372(CFrame.new(-902.568, 79.932, -10988.848))
                                                                                                                                                                        end
                                                                                                                                                                    else
                                                                                                                                                                        u1372(CFrame.new(-9515.372, 164.006, 5786.061))
                                                                                                                                                                    end
                                                                                                                                                                else
                                                                                                                                                                    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(-12471.17, 374.94, -7551.678))
                                                                                                                                                                end
                                                                                                                                                            else
                                                                                                                                                                u1372(CFrame.new(-13274.528, 531.821, -7579.223))
                                                                                                                                                            end
                                                                                                                                                        else
                                                                                                                                                            u1372(CFrame.new(5291.249, 1005.443, 393.762))
                                                                                                                                                        end
                                                                                                                                                    else
                                                                                                                                                        u1372(CFrame.new(-226.751, 20.603, 5538.34))
                                                                                                                                                    end
                                                                                                                                                else
                                                                                                                                                    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(-5083.26, 314.606, -3175.673))
                                                                                                                                                end
                                                                                                                                            else
                                                                                                                                                u1372(CFrame.new(2681.274, 1682.809, -7190.985))
                                                                                                                                            end
                                                                                                                                        else
                                                                                                                                            u1372(CFrame.new(4816.862, 8.46, 2863.82))
                                                                                                                                        end
                                                                                                                                    else
                                                                                                                                        u1372(CFrame.new(-3032.764, 317.897, -10075.373))
                                                                                                                                    end
                                                                                                                                else
                                                                                                                                    u1372(CFrame.new(6148.412, 294.387, -6741.117))
                                                                                                                                end
                                                                                                                            else
                                                                                                                                u1372(CFrame.new(923.402, 125.057, 32885.875))
                                                                                                                            end
                                                                                                                        else
                                                                                                                            u1372(CFrame.new(-6127.654, 15.952, -5040.286))
                                                                                                                        end
                                                                                                                    else
                                                                                                                        u1372(CFrame.new(753.143, 408.236, -5274.615))
                                                                                                                    end
                                                                                                                else
                                                                                                                    u1372(CFrame.new(-5622.033, 492.196, -781.786))
                                                                                                                end
                                                                                                            else
                                                                                                                u1372(CFrame.new(-1503.622, 219.796, 1369.31))
                                                                                                            end
                                                                                                        else
                                                                                                            u1372(CFrame.new(424.127, 211.162, -427.54))
                                                                                                        end
                                                                                                    else
                                                                                                        u1372(CFrame.new(-2448.53, 73.016, -3210.631))
                                                                                                    end
                                                                                                else
                                                                                                    u1372(CFrame.new(2284.414, 15.152, 875.725))
                                                                                                end
                                                                                            else
                                                                                                u1372(CFrame.new(-483.734, 332.038, 595.327))
                                                                                            end
                                                                                        else
                                                                                            u1372(CFrame.new(3780.03, 22.652, -3498.586))
                                                                                        end
                                                                                    else
                                                                                        u1372(CFrame.new(-11.311, 29.277, 2771.522))
                                                                                    end
                                                                                else
                                                                                    u1372(CFrame.new(-380.479, 77.22, 255.826))
                                                                                end
                                                                            else
                                                                                u1372(CFrame.new(-2850.201, 7.392, 5354.993))
                                                                            end
                                                                        else
                                                                            u1372(CFrame.new(-1442.166, 29.879, -28.355))
                                                                        end
                                                                    else
                                                                        u1372(CFrame.new(5127.128, 59.501, 4105.446))
                                                                    end
                                                                else
                                                                    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(61163.852, 11.68, 1819.784))
                                                                end
                                                            else
                                                                u1372(CFrame.new(-5247.716, 12.884, 8504.969))
                                                            end
                                                        else
                                                            u1372(CFrame.new(4875.33, 5.652, 734.85))
                                                        end
                                                    else
                                                ...
                                                u1372(CFrame.new(-4869.103, 733.461, -2667.018))
                                            end
                                        else
                                            u1372(CFrame.new(-1427.62, 7.288, -2792.772))
                                        end
                                    else
                                        u1372(CFrame.new(-4914.821, 50.964, 4281.028))
                                    end
                                else
                                    u1372(CFrame.new(1347.807, 104.668, -1319.737))
                                end
                            else
                                u1372(CFrame.new(944.158, 20.92, 4373.3))
                            end
                        else
                            u1372(CFrame.new(-1181.309, 4.751, 3803.546))
                        end
                    else
                        u1372(CFrame.new(-1612.796, 36.852, 149.128))
                    end
                else
                    u1372(CFrame.new(-690.331, 15.094, 1582.238))
                end
            else
                u1372(CFrame.new(-2566.43, 6.856, 2045.256))
            end
        else
            u1372(CFrame.new(979.799, 16.516, 1429.047))
        end
    end
end
...
local function u1391(p1389)
    local _Humanoid4 = p1389:WaitForChild('Humanoid', 5)
...
_LocalPlayer18.CharacterAdded:Connect(function(p1392)
    u1391(p1392)
end)

if _LocalPlayer18.Character then
    u1391(_LocalPlayer18.Character)
end
    ...
    while task.wait(1) do
        if _G.RemoveLava then
            ...
            while true do
                ...
                v1400, u1401 = v1398(v1399, v1400)

                if v1400 == nil then
                    break
                end
                if u1401:IsA('BasePart') and string.lower(u1401.Name):find('lava') then
                    pcall(function()
                        u1401:Destroy()
                    end)
                end
...
spawn(function()
    while wait() do
        if u1458 <= _LocalPlayer19.Data.Points.Value then
            local function v1466(p1464)
                ...
                _ReplicatedStorage2.Remotes.CommF_:InvokeServer(unpack(v1465))
            end
...
v620:AddButton({
    ...
    Callback = function()
        local v1467 = game
        local _Workspace3 = v1467.Workspace
...
v620:AddButton({
    ...
    Callback = function()
        local v1475, v1476, v1477 = ipairs(u1474)
        ...
        while true do
            ...
            pcall(function()
                game:GetService('ReplicatedStorage'):WaitForChild('Remotes'):WaitForChild('Redeem'):InvokeServer(unpack(u1479))
            end)
            task.wait(0.1)
        end
    end,
